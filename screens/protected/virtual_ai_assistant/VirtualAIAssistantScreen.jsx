...
export default function VirtualAIAssistantScreen() {
    /* Record State */
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <View style={AIResponse ? styles.mainContentContainerWithResponse : styles.mainContentContainerWithoutResponse}>
...
/> */}
                ...
                <View style={styles.textContainer}>
                    <Text style={styles.text}>
                        ...
                        {!isRecording && !AIResponse ? `Ask NiyogHub AI Virtual Assistant by pressing the microphone.` : userQuestion}
